...
async function addMonthDurationToMemberships() {
    try {
        ...
        for (const membership of memberships) {
            ...
            console.log(`✅ Updated: ${membership.name} - ${membership.durationType} -> ${monthDuration} month(s)`);
            updated++;
        }
        ...
        for (const membership of invalidMemberships) {
            ...
            console.log(`✅ Fixed invalid monthDuration: ${membership.name} -> ${monthDuration} month(s)`);
            updated++;
        }
