...
const mapDownloadedByUser = (value) => {
...
export default {
    Query: {
        getReportDownloadLogs: async (_, { limit, offset, reportType, }, context) => {
    ...
    Mutation: {
        logReportDownload: async (_, { input, }, context) => {
